...
{
    $this->db->select('a.purchase_id, a.purchase_date, a.manufacturer_id, c.manufacturer_name, SUM(b.quantity) as total_quantity, SUM(b.total_amount) as total_amount');
    $this->db->from('product_purchase a');
    $this->db->join('product_purchase_details b', 'b.purchase_id = a.purchase_id');
    $this->db->join('manufacturer_information c', 'c.manufacturer_id = a.manufacturer_id');
    $this->db->where('b.product_id', $product_id);
    $this->db->group_by('a.purchase_id, a.purchase_date, a.manufacturer_id, c.manufacturer_name');
