...
// DISTINCT (a.product_id),
     $this->db->select("DISTINCT (a.product_id),a.*,b.manufacturer_name,a.product_name,a.generic_name,a.strength,((select ifnull(sum(quantity),0) from product_purchase_details where product_id= `a`.`product_id`)-(select ifnull(sum(quantity),0) from invoice_details where product_id= `a`.`product_id`)) as 'stock'");
         $this->db->from('product_information a');
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                           ...
                                           <?php echo $stockout['product_name']?> 
                                            ...
                                            <input type="hidden" id="stockqty" class="stockqtymdl" value="<?php echo $stockout['stock']?>">   
                                        </td>
